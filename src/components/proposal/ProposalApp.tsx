...
export const ProposalApp = ({
  ...
  const memoryCaptions = [
    ...
    "Indha pic edukkura apo I made some efforts to stand near you. Un kuda photo edukkanum romba aasai patten",
    ...
    "Unakaga sivaraj kuda sanda poten. Un pinnadiye vandhen, Semma happy. But bus la total mood out.",
    "Oru period la oru vaati achu unna paathye aavanum enakku, Cuz you are so pretty ma.",
    "This is my fav candid pic of us ever ma. Indha mari unkuda life long okaranum nu aasai.",
    "Andha few days lab moments ah marakkavye maaten. Un pakkathula irukka avlo pudikkum.",
    "First time neraiya neram onna okandhu pesinom. See how you look at me. Idhye mari epomye paaru ma.",
